...
const credentials = [
  ...
  },
  {
    ...
    sub: "Journal of Engineering Research and Reports",
              ...
              <div className="space-y-2.5">
                {credentials.map((c, i) => {
                  const cardContent = (
                    <>
                      <div
                        className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 text-[15px] ${c.color}`}
                      >
                        {c.icon}
                      </div>
                      <div>
                        ...
                        {c.link && (
                          <span className="inline-flex items-center gap-1 text-[10px] font-medium text-blue-700 bg-blue-50 px-2 py-0.5 rounded-full mt-1.5">
                            {c.badge}
                          </span>
                        )}
                      </div>
                    ...
                    >
                      {c.link ? (
                        <a
                          ...
                          className="flex items-start gap-3.5 p-4 rounded-xl border border-border bg-card hover:border-primary/30 transition-colors no-underline"
                        >
                          {cardContent}
                        </a>
                      ) : (
                        <div className="flex items-start gap-3.5 p-4 rounded-xl border border-border bg-card hover:border-primary/30 transition-colors">
                          {cardContent}
                        </div>
                      )}
                    </motion.div>
